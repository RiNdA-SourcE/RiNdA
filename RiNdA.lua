...
{{text = '<𝖲𝗈𝗎𝖱𝖼𝖤🍒𝖱𝗂𝖭𝖽𝖠>', url="t.me/SourcE_RiNdA"}},
}
...
if #pv == i then 
if sendok == 0 then
send(msg.chat_id_, msg.id_,'⊀︰ ماڪو يࢪوحي مشتركين وهميين في البوت \n')   
else
local ok = #pv - sendok
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'⊀︰ ماڪو يࢪوحي كروبات وهميه في البوت\n')   
else
local RiNdA = (w + q)
...
texts = '*⊀︰ ماڪو يࢪوحي حساب بهاذا المعرف*'
end
...
send(msg.chat_id_, msg.id_, ' ⊀︰ المعرف ماڪو يࢪوحي فيه قناة')
return false  end
...
t = t:gsub('user',('@'..result.username_ or 'ماڪو يࢪوحي')) 
send(msg.chat_id_, msg.id_,'['..t..']')
end,nil) 
end 
end 
...
send(msg.chat_id_, msg.id_, " ⊀︰ ماڪو يࢪوحي قناة في الاشتراك الاجباري ")
end
return false  
end
...
local s1 = database:get(bot_id.."RiNdA:teh"..msg.chat_id_) or "ماڪو يࢪوحي توحيد"
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '<𝖲𝗈𝗎𝖱𝖼𝖤🍒𝖱𝗂𝖭𝖽𝖠> .',url="https://t.me/SourcE_RiNdA"}},{{text = '𝗗𝗲𝗩 𝗪𝗮𝗘𝗹 .',url="https://t.me/Wyyyyy"},{text = '𝗗𝗲𝗩 𝗛𝗮𝗦𝗼 .',url="https://t.me/Biiiii"}},{{text = '𝗥𝗶𝗡𝗱𝗔 𝗰𝗛𝗮𝗻𝗻𝗹 .',url="https://t.me/ebbxx"}},{{text = '𝗥𝗶𝗻𝗱𝗔 𝗦𝗨𝗣𝗣𝗢𝗥𝗧 .',url="https://t.me/joinchat/B-Qo-OmD86s2MzZi"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'حذف الاوامر المضافه' or text == 'وخر الاوامر المضافه' then
...
if text == 'حذف امر' or text == 'وخر امر' then 
if Constructor(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
send(msg.chat_id_, msg.id_," ⊀︰ ماڪو يࢪوحي اتصال من ال api \n") 
end
return false
end
end
...
if #list == 0 then
t = "* ⊀︰ ماڪو يࢪوحي احد في قائمه المالك*"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
send(msg.chat_id_, msg.id_,"*⊀︰ ماڪو يࢪوحي حساب بهاذا المعرف*")
end
end
...
Reply_Status(msg,result.sender_user_id_,"reply","*⊀︰ نزلته بـࢪو من المطور ثانويين*")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_RiNdA, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","*⊀︰ نزلته بـࢪو من المطور ثانويين*")  
else
send(msg.chat_id_, msg.id_,"*⊀︰ ماڪو يࢪوحي حساب بهاذا المعرف*")
end
end
...
Reply_Status(msg,userid,"reply","*⊀︰ نزلته بـࢪو من المطور ثانويين*")  
return false 
end
...
if num2 == 0 then
send(msg.chat_id_, msg.id_,"* ⊀︰ ماڪو يࢪوحي ادمنيه ليتم ارفعهم*") 
else
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⊀︰ ﭑݪعضوٍَ >* ['..data.first_name_..'](t.me/'..(data.username_ or 'SourcE_RiNdA')..')'
status  = '\n *⊀︰ الايدي >* `'..result.sender_user_id_..'`\n *⊀︰ نزلته بـࢪو ادمن من الكروب بكل الصلاحيات*'
send(msg.chat_id_, msg.id_, usertext..status)
...
send(msg.chat_id_, msg.id_,'ماڪو يࢪوحي رابط ارسل ` ضع رابط` لعمل رابط') 
end 
end,nil) 
end
end
if text == 'وخر الرابط' or text == 'حذف الرابط' then
if Mod(msg) then     
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == "حذف الصوره" or text == "وخر الصوره" then 
if Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == "وخر قائمه المنع"and Manager(msg) then   
...
if text == 'حذف الايدي' or text == 'وخر الايدي' then
if Manager(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == 'وخر القوانين' or text == 'حذف القوانين' then  
if Mod(msg) then
...
if text == 'طرد المحذوفين' or text == 'وخر المحذوفين' then  
if Mod(msg) then    
...
if text and text:match("^وخر صلاحيه (.*)$") and Mod(msg) then 
ComdNew = text:match("^وخر صلاحيه (.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'* ⊀︰ عدد ࢪسائلك > { '..database:get(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_)..'}*' ) 
end 
...
if text == ("اوخر") and cleaner(msg) then  
...
if #list == 0 then
t = "*⊀︰ ماڪو يࢪوحي ميديا في المجموعه*"
end
send(msg.chat_id_, msg.id_, t)
end
...
if #num == 0 then
l = "*⊀︰ ماڪو يࢪوحي ميديا في المجموعه*"
end
...
if text == ("وخر ردود المطور") and Devmode(msg) then 
...
local Text = Text:gsub('#username',(data.username_ or 'ماڪو يࢪوحي')) 
...
if text == ("وخر الردود المتعدده") and CoSu(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
------------------------------------------------------------------------
if Manager(msg) then
if text == ("وخر ردود الكروب") and not database:get(bot_id.."Rio:Lock:GpRd"..msg.chat_id_) then
...
send(msg.chat_id_, msg.id_,"⊀︰تـم وخر ࢪدود الكروب")
end
end
...
send(msg.chat_id_, msg.id_,"*⊀︰ انحـذف الـࢪد يࢪوحي*")
database:del(bot_id.."Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
Text = '\n *⊀︰ تعطل ࢪدود المـطوࢪ يڪلبي*' 
else
Text = '\n *⊀︰ معطل ࢪدود المطـوࢪ منزمان*'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
local username = ('[@'..data.username_..']' or 'ماڪو يࢪوحي')
...
-----------
if text ==("وخر") and Mod(msg) and tonumber(msg.reply_to_message_id_) > 0 then
...
local Teext =[[
منـوࢪني يا وࢪده
- ضݪع انته باوامࢪ م2 ↶ ﭑݪـتفعيـل و ﭑݪـتعطيل.
ـ↷𝖱𝗂𝖭𝖣𝖺↶
 ━━━━ 𝖱𝖠 ━━━━ 
•. نسـبه الحب 
•. نسـبه الࢪجولـه
...
•. قوانـين
•. تـࢪحـيب
( اوامـࢪ الاضـف↶  ) + الـࢪد او الامـࢪ ..🦇
•. اضـف رد
•. اضـف رد متعدد
•. تࢪتيب الاوامـࢪ
 ━━━━ 𝖱𝖠 ━━━━
⊀︰ . [<𝙎𝙤??𝙍𝙘𝙀🍒??𝙞𝙉𝙙𝘼>](t.me/SourcE_RiNdA)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
local Teext =[[
منـوࢪني يا وࢪده
- ضݪع انته باوامࢪ م4 ↶ وخـر/حذف  ← امـر
ـ↷𝖱𝗂𝖭𝖣𝖺↶
 ━━━━ 𝖱𝖠 ━━━━ 
وخـر + امـࢪ
•.الايـدي
...
•. البـوتـات
•. صـلاحـيه
•.قائـمـة مـنـ؏ المـتحـرڪـات
•.قائـمـة منـ؏ الصـوࢪ
•.قائـمـة مـنـ؏ الملـصقـات 
•. قـائـمـة الـمنـ؏
•. المحـذوفيـن
⊀︰ . [<𝖲𝗈𝗎𝖱𝖼𝖤🍒𝖱𝗂𝖭𝖽𝖠>](t.me/SourcE_RiNdA)
]]
...
local Teext =[[
منـوࢪني يا وࢪده
- ضݪع انته باوامࢪ م6 ↶ ﭑݪـڪࢪوب
ـ↷𝖱𝗂𝖭𝖣𝖺↶
 ━━━━ 𝖱𝖠 ━━━━ 
•. تحويـل : يحويـلكٍ صوره ⇆ ملصق 
•. صيـح المميزين او الادمنيه او المدࢪاء لخ..
•. ڪشف القيـود > بالࢪد
•. تعيـن الايدي > نوب اࢪسل الڪليشه
•. تنظيف + العدد
•. نـزل الكل > بالـࢪد
•. نزل جمـيع الرتب 
•. مـنع بالـࢪد > ملصـق متحࢪڪه > صوࢪه
•. حظࢪ > طـرد > ڪتم > تقيـد . بالـࢪد
•. تثبيت > الغاء تثبيت 
•. فحص البوتـت
•. ڪشف البوتات
•. تاك للكل 
•. خـلي لقب + لقب 
•. حذف لقب > بالـࢪد
•. ردود المديࢪ > تفعيل + تعطيل حذف ردود
•. اضف رد > تفعيل + تعطيل اضف رد
•. الاوامر المضـافه
•. خلي توحيـد + توحيد
•. غنيلي 
•. مميـز 
...
⊀︰ ارفع ← نزل منشئ اساسي
⊀︰ وخر الاساسين ← المنشئين الاساسين
⊀︰ وخر المنشئين ← المنشئين
⊀︰ اسم ~ ايدي + بوت غادر 
⊀︰ اذاعه 
━━━━𝖱𝗂𝖭𝖽𝖠━━━━ٴ
⊀︰ . [<𝖲𝗈𝗎𝖱𝖼𝖤🍒𝖱𝗂𝖭𝖽𝖠>](t.me/SourcE_RiNdA)
...
send(msg.chat_id_, msg.id_,'* ⊀︰ ماڪو يࢪوحي امر بهاذا الاسم*')  
end
